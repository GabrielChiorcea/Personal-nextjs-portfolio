...
const Projects = ({ index, slug, frontMatter, twoColumns }) => {
  ...
  return (
    <div
      data-aos
      className="bg-white rounded-lg overflow-hidden relative group h-full"
    >
      <span
      ...
      <Image
        ...
        className={`scale-150 group-[.aos-animate]:scale-100 duration-700 group-hover:!scale-125 object-contain w-full h-full bg-light/20 ${twoColumns ? "has-twoColumns" : ""}`}
